...
public class NewImageComponent {
    ...
    public NewImageComponent(String backgroundImage, TextComponent component) throws IOException {
        this.text = component;
    ...
    private void write() {
        ...
        attributes.forEach(imageAttribute -> {
            ...
            if (imageAttribute.attribute.equals(TextAttribute.FOREGROUND)) {
                ...
                color = new Color(color.getRed(), color.getGreen(), color.getBlue(), (int) (0.6 * 255));
        ...
        writedString.addAttribute(TextAttribute.BACKGROUND, new Color(1, 1, 1, (int) (0.4 * 255)));
        graphics.drawString(writedString.getIterator(), 50, 500);
        graphics.drawString(shadowString.getIterator(), 55, 505);
        graphics.dispose();
    }
